...
OverviewPanel.prototype.create = function(id) {
	...
	panelHTML += "<div class='callout polling'><h2>Polling</h2><p>Find out what Australia really thinks with Newspoll's insights into voters' preferred party and Prime Minister.</p><div class='pageBtn'>View the latest polls</div></div>";
